    ...
    <div class="main-body">
        ...
        <div class="main-container prepend5">
            <div class="main-content">
                <?php  $form = $this->beginWidget('ActiveForm', array('id' => 'forbid_login'));?>
                ...
                <div class="clearfix">
                    <div class="cell">
                        <label>请输入禁止登录时间:</label>
                        <div class="item">
                            <div class="main">
                                <input type="text" id="seconds" name="seconds" value="111" />
                            </div>
                        </div>
                    </div>
                </div>
