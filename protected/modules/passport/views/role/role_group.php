...
function drawTable( data ){
	...
	var store = Ext.create('Ext.data.Store', {
		...
		proxy: {
			type : 'ajax',
			url : js_url_path+'/index.php?r=/passport/role/rolegrouplist',
			reader : {
				root: 'dataList',
				...
				items: [{
					...
					handler: function(grid, rowIndex, colIndex) {
						...
						openWindow({
							...
							height:'190',
							className:'test',
							src:js_url_path+'/index.php?r=/passport/role/updaterolegroup/id/'+id
						});
					}
				},{
					...
					handler: function(grid, rowIndex, colIndex) {
					    ajaxCallBack.alert({
                            ...
                            url : js_url_path+'/index.php?r=/passport/role/deleterolegroup/'
                        });
					}
				}]
			}
...
<?php echo Html5::link('添加角色类型', array('/passport/role/addrolegroup'), array(
